...
init = async() => {
  ...
  //   {
  //     route: "/StableStatics",
  //     path:"/html/StableStatics.html",
  //   },
  //   {
  //     route: "/MonsterSkills",
  //     path:"/html/MonsterSkills.html",
  //   },
  //   {
  //     route: "/Menu",
  //     path:"/html/Menu.html",
  ...
  navStableStaticsButton.addEventListener("click", () => {
    window.location.href=("./StableStatics.html");
  });

  navMonsterSkillsButton.addEventListener("click", () => {
    window.location.href=("./MonsterSkills.html");
  });
